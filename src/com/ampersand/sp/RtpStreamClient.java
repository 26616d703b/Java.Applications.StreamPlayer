...
public class RtpStreamClient extends Thread {
	...
	public RtpStreamClient(String server_address, int server_port) {
	...
	public void run() {
		...
		if (!m_running) {
			...
			m_running = m_media_player_component.getMediaPlayer()
					.playMedia(formatRtpStream(m_server_address, m_server_port));
